...
export class WeatherService {
  ...
  otherForecast(city:string){
    return this.http.get(`http://api.openweathermap.org/data/2.5/forecast?q=${city},in&appid=0f3fb9fa31ad3d41f1bb2bd0841c3f2f&units=imperial`).pipe(map((response:Response) => response.json()));
  }
